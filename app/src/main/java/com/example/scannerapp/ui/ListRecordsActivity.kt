...
class ListRecordsActivity : BaseActivity(R.layout.activity_list_records) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*val newRecord = Record(recordId = 0, recordDate = "28/09/2023", recordQuantityChanged = 25,  recordRemarks = "testing", recordType = RecordType.TAKE_OUT, isActive = 1,batchId = 1, userId = 1)
